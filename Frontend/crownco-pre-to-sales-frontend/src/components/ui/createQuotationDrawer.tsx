...
export function CreateQuotationDrawer({
  ...
  useEffect(() => {
    if (editingQuotation && isOpen) {
      setFormData({
        ...
        channelPartner:
          editingQuotation.assignedRepresentative?.channelPartner || "",
  ...
  const calculateFinalPrice = () =>
    formData.priceBreakdown.reduce((sum, item) => sum + item.amount, 0);
  ...
  return (
    ...
    >
      {/* Form Content */}
      <div className="p-1 sm:p-2 space-y-4 sm:space-y-6">
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="border border-[var(--sidebar-border-color)] rounded-lg p-4 space-y-4">
              <h3 className="text-base font-semibold text-[var(--sidebar-text-main)]">
                Allocated Flat Info
              </h3>
            ...
            <div className="border border-[var(--sidebar-border-color)] rounded-lg p-4 space-y-4">
                ...
                {formData.priceBreakdown.map((item, index) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div
                        className={`text-xs ${
                          item.isDiscount ? "text-red-600" : "text-gray-600"
                        }`}
                      >
                        {item.isDiscount ? "-" : "+"} ₹
              ...
              <div className="border-t pt-4 space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setNewPriceItem({ ...newPriceItem, label: e.target.value })
                    }
              ...
              <div className="pt-4 border-t">
                <div className="flex justify-between items-center">
                  <span className="text-base font-bold text-[var(--sidebar-text-main)]">
                    Final Deal Price
                  </span>
          ...
          <div className="mt-4 sm:mt-6 p-4 sm:p-6 border-t border-[var(--sidebar-border-color)] bg-white flex gap-3 sm:gap-4">
            <button
              onClick={onClose}
