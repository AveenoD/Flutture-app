...
export interface ProjectCardProps {
  ...
  features?: string[];
  // Simple mode props (for dashboard/performance)
  stats?: string;
  conversion?: string;
...
export function ProjectCard({
  ...
  // Determine if it's simple mode (dashboard/performance) or detailed mode (project inventory)
  ...
  return (
    ...
    >
      ...
      <div className={isSimpleMode ? "px-2.5 sm:px-3 pb-2.5 sm:pb-3 pt-1.5 sm:pt-2" : "p-3 sm:p-4 md:p-5"}>
        {isSimpleMode ? (
          // Simple mode (Dashboard/Performance)
          <>
